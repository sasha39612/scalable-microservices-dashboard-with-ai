 ...
 */
export function hasMinLength(arr: unknown[], minLength: number): boolean {
 ...
 */
export function hasMaxLength(arr: unknown[], maxLength: number): boolean {
 ...
 */
export function isInAllowedValues<T>(value: T, allowedValues: T[]): boolean {
